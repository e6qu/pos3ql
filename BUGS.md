...
There are no known unresolved bugs. Last reviewed: 2026-08-25 after the PostgreSQL 18 index and provider-neutral tablespace lifecycle audit across catalogs, wire, dump/restore, WAL, checkpoints, and cold recovery. Details belong in tests and git history, not this blocker register.
