...
There are no known unresolved bugs. Last reviewed: 2026-08-21 after array/composite SQL, wire, COPY, catalog, dump/restore, WAL, checkpoint, crash-restart, and object-store cold-recovery coverage. Details belong in tests and git history, not this blocker register.
