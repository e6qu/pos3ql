...
There are no known unresolved bugs. Last reviewed: 2026-08-26 against PostgreSQL 18.6 across accepted types, common-table-expression evaluation, nested query scopes, portals, drivers, COPY, stored queries, dump/restore, WAL, checkpoints, and provider-neutral cold recovery. Details belong in tests and git history, not this blocker register.
