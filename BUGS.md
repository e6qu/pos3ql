...
There are no known unresolved bugs. Last reviewed: 2026-08-24 after the PostgreSQL 18 constraint lifecycle, enforcement, dependency, wire, driver, and cold-recovery matrix. Details belong in tests and git history, not this blocker register.
