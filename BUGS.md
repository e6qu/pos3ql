...
There are no known unresolved bugs. Last reviewed: 2026-08-24 after declarative partition routing, attachment, pruning, replication, dump/restore, checkpoints, and object-store cold recovery. Details belong in tests and git history, not this blocker register.
