...
There are no known unresolved bugs. Last reviewed: 2026-08-23 after row/SRF SQL, wire, routine dependencies, stored-query identity changes, checkpoint, and object-store cold-recovery coverage. Details belong in tests and git history, not this blocker register.
