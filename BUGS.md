...
There are no known unresolved bugs. Last reviewed: 2026-08-27 against PostgreSQL 18.6 across query semantics, routine parameter and call contracts, accepted types, portals, drivers, COPY, catalogs, WAL, checkpoints, and provider-neutral cold recovery. Details belong in tests and git history, not this blocker register.
