...
The geometric and inverted index-navigation, concurrent-harness port, and
integration-scratch audits have no external blocker; their fixes are qualified
in the implementation and regression suites.
