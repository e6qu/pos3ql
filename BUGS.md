...
There are no known unresolved bugs. Last reviewed: 2026-08-26 against PostgreSQL 18.4 across trigger and constraint timing, partitions, views, dependencies, catalogs, wire behavior, dump/restore, WAL, checkpoints, and provider-neutral cold recovery. Details belong in tests and git history, not this blocker register.
