...
There are no known unresolved bugs. Last reviewed: 2026-08-24 after PostgreSQL 18 and pos3ql subscription bootstrap, durable failures, managed-slot cleanup, and object-store recovery. Details belong in tests and git history, not this blocker register.
