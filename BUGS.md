...
There are no known unresolved bugs. Last reviewed: 2026-08-26 against PostgreSQL 18.6 across accepted types, typmods, portals, SQL cursors, drivers, COPY, catalogs, dump/restore, WAL, checkpoints, and provider-neutral cold recovery. Details belong in tests and git history, not this blocker register.
