...
There are no known unresolved bugs. Last reviewed: 2026-08-08; object-store recovery, cancellation framing, garbage collection, binary cursor framing, catalog-aware binary decoding, and test-only code were audited.
