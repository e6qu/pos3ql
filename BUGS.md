...
There are no known unresolved bugs. Last reviewed: 2026-08-23 after row/SRF overload identity, stored dependencies, record shape, domain wire descriptions, dump/restore, checkpoints, and object-store cold recovery. Details belong in tests and git history, not this blocker register.
