...
There are no known unresolved bugs. Last reviewed: 2026-08-20 after catalog, PostgreSQL differential, extended-protocol, raw-wire, and streamed COPY coverage added partition visibility and writable-parent cases. Details belong in tests and git history, not this blocker register.
