...
There are no known unresolved bugs. Last reviewed: 2026-08-28 against PostgreSQL 18.6 across query semantics, routines, cast overload and binary-coercion contracts, prefix/binary operators, executable modeled btree operator families/classes, DML dependencies, privileges, accepted types, portals, drivers, COPY, catalogs, WAL, checkpoints, and provider-neutral cold recovery. Details belong in tests and git history, not this blocker register.
