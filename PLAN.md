...
- SQL function query inputs and results cross the projected-row codec; scalar calls cannot resolve set-returning definitions, and table calls cannot resolve scalar definitions.
