...
5. **Replication and physical demand.** In progress: publication DDL and pgoutput streaming are covered by unit, raw-wire, and PostgreSQL differential probes. Complete object-native logical replication and demand propagation through every executor path.
