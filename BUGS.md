...
There are no known unresolved bugs. Last reviewed: 2026-08-25 after the PostgreSQL 18 row-level-security DDL, enforcement, privilege, catalog, wire, dump/restore, replication-apply, and recovery matrix. Details belong in tests and git history, not this blocker register.
