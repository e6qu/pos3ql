...
There are no known unresolved bugs. Last reviewed: 2026-08-20 after PostgreSQL differential coverage added range, list, hash, default, and writable-parent partition cases. Details belong in tests and git history, not this blocker register.
