...
There are no known unresolved bugs. Last reviewed: 2026-08-17. The CI suite covers object-store recovery, protocol framing, catalog-aware Bind/Result/COPY, PostgreSQL-oracle SQL and type matrices, drivers, durable table and view-trigger lifecycles (including joined DML and pg_dump restoration into PostgreSQL), transactional subscriptions, pgoutput recovery, named-type identity moves, and cold physical-demand execution. Details belong in tests and git history, not this blocker register.
