...
There are no known unresolved bugs. Last reviewed: 2026-08-28 against PostgreSQL 18.6 across query semantics, database and tablespace isolation, session and transaction configuration, routines, casts/operators, privileges, accepted types, portals, drivers, COPY, WAL, checkpoints, and provider-neutral cold recovery. Details belong in tests and git history, not this blocker register.
