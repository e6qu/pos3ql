...
There are no known unresolved bugs. Last reviewed: 2026-09-03 against PostgreSQL 18 across schema grammar, role identity, inline trigger/grant ownership, WAL, checkpoint, and object-cold recovery. Unsupported PostgreSQL behavior is an explicit typed boundary, not deferred work. Details belong in tests and git history, not this blocker register.
