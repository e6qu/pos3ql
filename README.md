...
The completion work is physical-demand propagation through query execution, logical-replication interoperability and subscription, and remaining PostgreSQL SQL/catalog/tooling coverage. See [PLAN.md](PLAN.md).
