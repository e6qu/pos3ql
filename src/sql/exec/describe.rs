...
pub fn infer_type_res(
    ...
    Ok(match expression {
        ...
        Expr::Call {
            ...
            "to_regproc" => (oid::REGPROC, 4),
            "to_regprocedure" => (oid::REGPROCEDURE, 4),
            "to_regoper" => (oid::REGOPER, 4),
            "to_regoperator" => (oid::REGOPERATOR, 4),
            "to_regtype" => (oid::REGTYPE, 4),
            "to_regnamespace" => (oid::REGNAMESPACE, 4),
            "to_regrole" => (oid::REGROLE, 4),
            "to_regcollation" => (oid::REGCOLLATION, 4),
            "to_regtypemod" => (oid::INT4, 4),
