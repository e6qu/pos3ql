...
impl<'a> Parser<'a> {
    ...
    pub(super) fn peek_binary_op(&self) -> Option<BinaryOp> {
        match self.peeked {
            ...
            Tok::Op("~<~") => Some(BinaryOp::PatternLt),
            Tok::Op("~<=~") => Some(BinaryOp::PatternLtEq),
            Tok::Op("~>~") => Some(BinaryOp::PatternGt),
            Tok::Op("~>=~") => Some(BinaryOp::PatternGtEq),
            ...
            Tok::Op("^@") => Some(BinaryOp::StartsWith),
            ...
            Tok::Op("~=") => Some(BinaryOp::Same),
            Tok::Op("<<|") => Some(BinaryOp::Below),
            Tok::Op("|>>") => Some(BinaryOp::Above),
            Tok::Op("&<|") => Some(BinaryOp::NotAbove),
            Tok::Op("|&>") => Some(BinaryOp::NotBelow),
            Tok::Op("<^") => Some(BinaryOp::BelowPoint),
            Tok::Op(">^") => Some(BinaryOp::AbovePoint),
