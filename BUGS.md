...
There are no known unresolved bugs. Last reviewed: 2026-08-23 after exact record metadata/collation, row/SRF SQL, quantified subqueries, wire, dump/restore, routine dependencies, checkpoints, and object-store cold recovery. Details belong in tests and git history, not this blocker register.
