...
STATIC_COLUMNS = [
    ...
    ("money_value", "money", "'$1,234.565'"),
    ("tuple_identifier", "tid", "'(4294967295,65535)'"),
    ("command_identifier", "cid", "'4294967295'"),
    ...
    ("point_value", "point", "'(1,2)'"),
    ("lseg_value", "lseg", "'[(1,2),(3,4)]'"),
    ("path_value", "path", "'[(1,2),(3,4)]'"),
    ("box_value", "box", "'(1,2),(3,4)'"),
    ("polygon_value", "polygon", "'((1,2),(3,4),(5,6))'"),
    ("line_value", "line", "'{1,2,3}'"),
    ("circle_value", "circle", "'<(1,2),3>'"),
    ...
    ("money_array", "money[]", "ARRAY['$1.23'::money, NULL, '-$4.56'::money]"),
    ("tuple_identifier_array", "tid[]", "ARRAY['(0,1)'::tid, NULL, '(4294967295,65535)'::tid]"),
    ("command_identifier_array", "cid[]", "ARRAY['0'::cid, NULL, '4294967295'::cid]"),
    ...
    ("point_array", "point[]", "ARRAY['(1,2)'::point, NULL, '(3,4)'::point]"),
    ("lseg_array", "lseg[]", "ARRAY['[(1,2),(3,4)]'::lseg, NULL, '[(5,6),(7,8)]'::lseg]"),
    ("path_array", "path[]", "ARRAY['[(1,2),(3,4)]'::path, NULL, '((5,6),(7,8))'::path]"),
    ("box_array", "box[]", "ARRAY['(1,2),(3,4)'::box, NULL, '(5,6),(7,8)'::box]"),
    ("polygon_array", "polygon[]", "ARRAY['((1,2),(3,4),(5,6))'::polygon, NULL, '((7,8),(9,10),(11,12))'::polygon]"),
    ("line_array", "line[]", "ARRAY['{1,2,3}'::line, NULL, '{4,5,6}'::line]"),
    ("circle_array", "circle[]", "ARRAY['<(1,2),3>'::circle, NULL, '<(4,5),6>'::circle]"),
