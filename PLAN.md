...
- Publication membership and operations are staged as one typed definition; catalog reads see their own staged state, while replication sees only the committed definition.
