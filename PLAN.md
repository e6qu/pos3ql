...
4. **Wire and binary protocol.** Match PostgreSQL Bind, Result, COPY, cancellation, array/range/composite, and typmod bytes for every accepted type. Binary Bind resolves catalog types before decoding, including domains, enums, and their arrays; malformed structured values fail as a whole.
