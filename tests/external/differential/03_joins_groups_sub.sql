...
SELECT pg_typeof(generate_series(1.5::numeric, 2.5::numeric, 0.5::numeric));
SELECT s FROM generate_series(1, 2.0::numeric, 0.5::numeric) AS g(s) ORDER BY s;
SELECT generate_series(3.0::numeric, 1.0::numeric, -0.5::numeric);
SELECT generate_series(1.0::numeric, 2.0::numeric, 0::numeric);
SELECT generate_series(1.0::numeric, 2.0::numeric);
SELECT generate_series('2024-01-01'::timestamp, '2024-01-02'::timestamp);
